...
classes. The packet class is ignored for transmission and in absence of classifier, the packet class is \textit{0x00}.\\
...
(https://gitlab.com/ohwr/project/wr-cores.git) and consists of the files:
\begin{itemize}
