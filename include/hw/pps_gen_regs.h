...
/* definitions for register: Lock Sweep register */

/* definitions for field: Phase position in reg: Lock Sweep register */
#define PPSG_LOCK_SWEEP_PHASE_MASK            WBGEN2_GEN_MASK(0, 16)
#define PPSG_LOCK_SWEEP_PHASE_SHIFT           0
#define PPSG_LOCK_SWEEP_PHASE_W(value)        WBGEN2_GEN_WRITE(value, 0, 16)
#define PPSG_LOCK_SWEEP_PHASE_R(reg)          WBGEN2_GEN_READ(reg, 0, 16)

/* definitions for field: status in reg: Lock Sweep register */
#define PPSG_LOCK_SWEEP_STAT                  WBGEN2_GEN_MASK(16, 1)
